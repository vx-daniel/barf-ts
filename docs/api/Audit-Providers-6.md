...
> **OpenAIFactory** = (`apiKey`) => `OpenAI`

Defined in: src/providers/openai.ts:25
...
Defined in: src/providers/openai.ts:35
...
> **new OpenAIAuditProvider**(`config`, `clientFactory?`): [`OpenAIAuditProvider`](#openaiauditprovider)

Defined in: src/providers/openai.ts:40
...
[`OpenAIAuditProvider`](#openaiauditprovider)
...
Defined in: src/providers/openai.ts:36
...
Defined in: src/providers/openai.ts:130
...
Defined in: src/providers/openai.ts:54
...
Defined in: src/providers/openai.ts:68
...
Defined in: src/providers/openai.ts:165
...
Tier classification uses [OPENAI\_TIERS](Audit-Providers-5.md#openai_tiers) with keyword fallback via [inferTier](Audit-Providers-5.md#infertier).
...
Defined in: src/providers/openai.ts:175
...
Raw response object from the OpenAI SDK.
...
Defined in: src/providers/openai.ts:89
