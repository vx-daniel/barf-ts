...
| Task | Entry point |
|------|-------------|
| Add a CLI command | `src/cli/commands/` — see [Adding a Command](_media/adding-a-command.md) |
| Add an audit provider | `src/providers/` — see [Adding an Audit Provider](_media/adding-an-audit-provider.md) |
