...
> **createIssueProvider**(`config`): `Result`\<[`IssueProvider`](Issue-Model.md#abstract-issueprovider), [`Error`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Error)\>

Defined in: src/core/issue/factory.ts:16
...
`Result`\<[`IssueProvider`](Issue-Model.md#abstract-issueprovider), [`Error`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Error)\>
