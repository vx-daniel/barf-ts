...
> **resolvePromptTemplate**(`mode`, `config`): `string`

Defined in: src/core/prompts.ts:48
...
Which prompt template to resolve.

`"plan"` | `"build"` | `"split"` | `"audit"` | `"triage"`

##### config

Barf configuration containing `promptDir`.
