...
[barf](../../../../../README.md) / [core/issue/providers/local](../README.md) / LocalIssueProvider

# Class: LocalIssueProvider

Defined in: src/core/issue/providers/local.ts:39
...
Stale locks (dead PID) are swept at construction and on every [isLocked](#islocked) / [lockIssue](#lockissue) call.
...
> **new LocalIssueProvider**(`issuesDir`, `barfDir`): `LocalIssueProvider`

Defined in: src/core/issue/providers/local.ts:40
...
Defined in: src/core/issue/providers/local.ts:134
...
> **deleteIssue**(`id`): `ResultAsync`\<`void`, [`Error`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Error)\>

Defined in: src/core/issue/providers/local.ts:178
...
Defined in: src/core/issue/providers/local.ts:87
...
Defined in: src/core/issue/providers/local.ts:253
...
Defined in: src/core/issue/providers/local.ts:102
...
> **lockIssue**(`id`, `meta?`): `ResultAsync`\<`void`, [`Error`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Error)\>

Defined in: src/core/issue/providers/local.ts:187
...
Defined in: src/core/issue/providers/local.ts:244
...
Defined in: src/core/issue/providers/local.ts:162
