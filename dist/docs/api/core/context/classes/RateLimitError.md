...
[barf](../../../README.md) / [core/context](../README.md) / RateLimitError

# Class: RateLimitError

Defined in: src/core/context.ts:25

Thrown by [parseClaudeStream](../functions/parseClaudeStream.md) when Claude's API returns a rate-limit event.
...
> **new RateLimitError**(`resetsAt?`): `RateLimitError`

Defined in: src/core/context.ts:26
