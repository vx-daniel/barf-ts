...
[barf](../../../README.md) / [core/context](../README.md) / ContextOverflowError

# Class: ContextOverflowError

Defined in: src/core/context.ts:11

Thrown by [parseClaudeStream](../functions/parseClaudeStream.md) when cumulative token usage reaches the configured
...
> **new ContextOverflowError**(`tokens`): `ContextOverflowError`

Defined in: src/core/context.ts:12
